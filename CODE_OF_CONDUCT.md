...
- Publishing others’ private information (including keys, emails, or physical addresses) without explicit permission
...
Report incidents to **escape@portabase.dev**. All complaints will be reviewed
...
1. **Correction** — private warning for unprofessional or unwelcome behavior
2. **Warning** — a warning with consequences for continued behavior
3. **Temporary ban** — temporary ban from interaction
4. **Permanent ban** — permanent ban for a pattern of violation or harassment
